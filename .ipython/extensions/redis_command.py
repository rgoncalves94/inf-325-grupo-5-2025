""""
Credits thedatasociety
https://github.com/thedatasociety/lab-redis/blob/master/.ipython/extensions/redis_command.py
"""
...
r = redis_db.Redis(host='redis', port=6379, db=0)
